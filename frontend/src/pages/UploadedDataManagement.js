        ...
        <Row className="mb-4">
          <Col md={3}>
            <SummaryCard color1="#667eea" color2="#764ba2">
              <Card.Body>
                <div className="summary-value">{summary.totalUploads}</div>
          ...
          <tbody>
            {filteredUploads.map(upload => (
              <tr key={upload._id}>
                ...
                <td>{upload.successRecords}/{upload.totalRecords}</td>
                <td>
                ...
                <td>
                  <span style={{ color: '#dc3545', fontWeight: '600' }}>
                    {formatCurrency(upload.profitSummary.rpuProfit)}
                  </span>
                </td>
                <td>
                  <span style={{ 
                    fontWeight: '600',
                    color: upload.profitSummary.netProfit >= 0 ? '#007bff' : '#dc3545'
                  }}>
                    {formatCurrency(upload.profitSummary.netProfit)}
                  </span>
                </td>
                <td>
                  <Badge bg="success">{upload.status}</Badge>
                </td>
                <td>
                  <ActionButtonGroup>
                    <Button
            ...
            <>
              <Row className="mb-3">
                ...
                <Col md={6}>
                  ...
                  <p>{selectedUpload.successRecords} successful / {selectedUpload.totalRecords} total</p>
                </Col>
              </Row>
                  ...
                  <Card className="text-center">
                    <Card.Body>
                      <div style={{ 
                        fontSize: '1.5rem', 
                        fontWeight: '700',
                        color: selectedUpload.profitSummary.netProfit >= 0 ? '#007bff' : '#dc3545'
                      }}>
